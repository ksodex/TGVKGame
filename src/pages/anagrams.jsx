...
import { SymbolButtons } from "../components/games/anagrams/SymbolButtons"
import { RemoveButton } from "../components/games/anagrams/RemoveButton"
import { WordInput } from "../components/games/anagrams/WordInput"
...
import { useGameStateAnnagrams as useGameState } from "../hooks/state/useGameState"
import { useGameLogicAnnagrams as useGameLogic } from "../hooks/state/useGameLogic"
import { useSymbolInteraction } from "../hooks/state/useSymbolInteraction"
    ...
    useEffect(() => {
        if (
            ...
            const word = gameState.attachedSymbols
                .map((attached) => attached.symbol)
                .join("")
            checkWord(word)
        }
    }, [gameState.attachedSymbols])
