    ...
    <div className="grid grid-cols-4 gap-4">
        {aviableSymbols.map((symbolObj) => (
            <button
                ...
                className={`flex items-center justify-center border-2 rounded-md aspect-square transition-colors p-1 ${attachedSymbols.some((attached) => attached.id === symbolObj.id)
                        ? "border-[#430B5150]"
                        : "border-[#430B51]"
                    }`}
            ...
            >
                <span
                    className={`${attachedSymbols.some((attached) => attached.id === symbolObj.id)
                            ? "text-[#430B5150]"
                            : "text-[#430B51]"
